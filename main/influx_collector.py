#!/usr/bin/env python3
"""
PHCA InfluxDB Metrics Collector - Original Jan 30 Version
...
class PHCAInfluxCollector:
    ...
    def collect_metrics_continuously(self, duration_minutes: int = 60, interval_seconds: int = 5):
        ...
        try:
            ...
            # CRITICAL: Close client to flush pending writes
            if self.client:
                self.client.close()
...
def main():
    ...
    if containers:
        ...
        print("   cd microservices-demo/deploy/docker-compose")
    ...
    print(f"3. Collect metrics for 1 hour")
    ...
    if choice == "1":
        ...
        collector.collect_metrics_continuously(duration_minutes=60)
